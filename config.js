...
// Auth information
global.pairNumber = "94763809289";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["94763809289];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["94763809289];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(".") : ["94763809289"];
global.OwnerName = process.env.OWNER_NAME || "Mr gima";
